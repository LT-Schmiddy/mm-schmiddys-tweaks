...
// // s32 DmaMgr_SendRequest0(void *vramStart, u8 * vromStart, size_t size);
...
//         msgCtx->msgLength = font->messageEnd;
//         // msgCtx->msgLength = 18;
//         DmaMgr_SendRequest0(&font->msgBuf, (uintptr_t)&SEGMENT_ROM_START(message_data_static)[font->messageStart], (size_t)font->messageEnd);


//         recomp_printf("Message Size %d",  msgCtx->msgLength);
//         // font->msgBuf.schar[0] = 'p';

//         // memcpy(&font->msgBuf, idk, 18);
//         // for(int i = 0; i < msgCtx->msgLength; i++){
//             // font->msgBuf.schar[i] = 'p';
//         // }
        

//         // recomp_printf("MESSAGE: %s", font->msgBuf);
//     }
